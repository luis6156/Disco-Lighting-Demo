...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes[obj_type], glm::vec3(-2.2f, 0.5f, 0), glm::vec3(0.3f));

    RenderMesh(meshes["archer"], glm::vec3(x_pos, y_pos, z_pos), glm::vec3(0.005f));
}
...
void Lab1::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (window->KeyHold(GLFW_KEY_SPACE)) {
        y_pos = glm::abs(glm::sin(freq * Engine::GetElapsedTime()));
    }
