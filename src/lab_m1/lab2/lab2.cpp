...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, -1, 1), glm::vec3(0.13f, 0.2f, 0.7f)),
            VertexFormat(glm::vec3(-1, 0, 1), glm::vec3(0.23f, 0.9f, 0.6f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.18f, 0.56f, 0.7f)),
            VertexFormat(glm::vec3(-1, -1, 0), glm::vec3(0.33f, 0.2f, 0.7f)),
            VertexFormat(glm::vec3(0, -1, 0), glm::vec3(0.43f, 0.9f, 0.6f)),
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0.38f, 0.56f, 0.7f)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.13f, 0.2f, 0.7f))
        };
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 1, 0)),           // 2
            
            // Vertex 1
            VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(1, 0, 0)),        // 3
            VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(0, 1, 0)),        // 4
            VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(0, 0, 1)),        // 5

            // Vertex 2
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 0)),           // 6
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 1, 0)),           // 7
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0, 1)),           // 8

            // Vertex 3
            VertexFormat(glm::vec3(0.5f, 1, 0.5f), glm::vec3(1, 1, 0)),     // 9
            VertexFormat(glm::vec3(0.5f, 1, 0.5f), glm::vec3(0, 1, 0)),     // 10
            VertexFormat(glm::vec3(0.5f, 1, 0.5f), glm::vec3(0, 0, 1))      // 11
        };
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.73, 0.12, 0.7)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.73, 0.12, 0.7)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.73, 0.19, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.78, 0.56, 0.7))
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2.5f, 1, -1.5f), glm::vec3(1));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(3.5f, 0.5f, -2.5f), glm::vec3(0.8f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(5, 0, 1.2f));
